...
bool moxie::utils::StringSplitBychar(const std::string& src,
                                   const char delimter,
...
std::string moxie::utils::StringTrimLeft(const std::string& src) {
  size_t startTrimPos = src.find_first_not_of(' ');
  return src.substr(startTrimPos, src.length() - startTrimPos);
}

std::string moxie::utils::StringTrimRight(const std::string& src) {
  return src.substr(0, src.find_last_not_of(' ') + 1);
}

std::string moxie::utils::StringTrim(const std::string& src) {
  size_t startTrimPos = src.find_first_not_of(' ');
  size_t endTrimPos = src.find_last_not_of(' ') + 1;
  return src.substr(startTrimPos, endTrimPos - startTrimPos);
}

std::string moxie::utils::StringRemoveRepeatChar(const std::string& src, const std::string& op) {
...
std::string moxie::utils::StringGetSuffix(const std::string& src) {
